...
We implement a highly parallel algorithm for fitting Hawkes processes via **exact maximum likelihood estimation**. This allows scaling to massive datasets; e.g., $\sim 1{\small,}000$ nodes and $10{\small,}000{\small,}000$ events. Therefore, a GPU or many CPU cores are recommended to realize these speedups.
